<template>
  <b-tabs pills card vertical>
    ...
    <BoardTab boardTitle="게임 이야기" boardId='PcGameTalk'/>
    <BoardTab boardTitle="잡담 게시판" boardId='PcFreeTalk'/>
    <BoardTab boardTitle="질문 게시판" boardId='PcQ&A'/>
    <BoardTab boardTitle="리뷰 게시판" boardId='PcReview'/>
  </b-tabs>
</template>
